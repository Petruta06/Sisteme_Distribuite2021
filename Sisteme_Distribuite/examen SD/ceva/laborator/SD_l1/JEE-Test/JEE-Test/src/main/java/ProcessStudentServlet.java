...
public class ProcessStudentServlet extends HttpServlet {
    public static File f = new File("/home/ana/Desktop/SD_l1/student.xml");
    public ClassOfStudents c = new ClassOfStudents();
    @Override
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        mapper.writeValue(ProcessStudentServlet.f,  c);
