...
class TeacherMicroservice {
    ...
    companion object Constants {
        // pentru testare, se foloseste localhost. pentru deploy, server-ul socket (microserviciul MessageManager) se identifica dupa un
        //"hostname"
...
// (in acest caz, din partea aplicatiei client GUI)
            ...
            //pornesc corutina pentru tratarea cererii
            GlobalScope.async{
                conection(clientConnection)
            }
...
suspend fun conection(clientConnection: Socket): String {
