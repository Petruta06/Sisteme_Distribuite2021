...
fun main(args: Array<String>) {
    ...
    // 1. spargerea fiecarui string intr-o lista de substring-uri si reuniunea intr-o singura lista
    // 2. filtrarea cu regex pentru a pastra doar numele
    ...
    // abia cand se ajunge la functia de reducere Spark imparte operatiile in task-uri
    ...
    // transmiterea unor functii catre Spark
