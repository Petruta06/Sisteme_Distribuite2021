...
def resolve_question(question_text):
    ...
    try:
        sock.connect((HOST, STUDENT_PORT))

        response_widget.insert(END, f"Intrebare : {question_text}\n")
        ...
        response_text = "Raspuns : " + str(sock.recv(1024), "utf-8")
...
if __name__ == '__main__':
    root = Tk()
    root.title("Interactiune studenti-studenti/profesor")
