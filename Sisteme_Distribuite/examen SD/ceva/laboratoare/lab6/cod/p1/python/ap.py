...
class RabbitMq:
	...
	'username': 'student',
	'password': 'student',
	'exchange': 'aplicatieSQL.direct',
	'routing_key': 'sql.routingkeyP',
	'queue': 'sql.kotlin'
	}
	credentials = pika.PlainCredentials(config['username'], config['password'])
	parameters = (pika.ConnectionParameters(host=config['host']),pika.ConnectionParameters(port=config['port']),pika.ConnectionParameters(credentials=credentials))
